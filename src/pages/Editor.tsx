...
import { ItemDialog } from "@/components/add-item";
        ...
        <div className="hidden flex-col md:flex">
          <div className="border-b">
            <div className="flex h-16 items-center px-4">
              <Button className="absolute right-2 top-2 md:right-4 md:top-4" variant="ghost">
                <Link to="/profile">
                    Profile
                </Link>
              </Button>
      ...
      <div className="flex flex-row bg-[#E7ECEF] h-screen">
        <div className="w-1/2 p-4 flex-col">
            ...
            <ScrollArea className="h-[525px] w-full rounded-md mt-4 border bg-white">
                <div className="p-4">
                    <h4 className="mb-4 text-sm font-medium leading-none">Resume Items</h4>
                    {tags.map((tag) => (
                    <>
